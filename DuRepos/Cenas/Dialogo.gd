...
func _process(delta):
	...
	if Input.is_action_just_pressed("ui_accept"):
		if finished:
			...
			$TextureRect/Texto2.visible_characters = len($TextureRect/Texto2.text)
...
func nextPhrase() -> void:
	...
	while $TextureRect/Texto2.visible_characters < len($TextureRect/Texto2.text):
		$TextureRect/Texto2.visible_characters += 1
